...
from evaluation.got_benchmark.experiments import ExperimentGOT10k
...
class GOT10kTester(TesterBase):
    ...
    def test(self, ):
        ...
        nr_cudas = torch.cuda.device_count()
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            if nr_devs == 1:
                ...
                experiment.run(pipeline_tracker,save_video=False,overwrite_result=False)
            # multi-worker
            else:
                procs = []
