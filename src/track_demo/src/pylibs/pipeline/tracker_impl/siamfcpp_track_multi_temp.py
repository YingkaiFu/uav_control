...
from pipeline.pipeline_base import TRACK_PIPELINES
from pipeline.tracker_impl.siamfcpp_track import SiamFCppTracker
from pipeline.utils import (get_crop, get_subwindow_tracking,
