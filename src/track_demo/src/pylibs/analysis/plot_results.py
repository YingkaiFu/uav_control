...
def check_and_load_precomputed_results(trackers, dataset, report_name, result_plot_path,force_evaluation=False, **kwargs):
    # Load data

    # Load pre-computed results
    result_plot_path = os.path.join(result_plot_path, report_name)
    ...
    if os.path.isfile(eval_data_path) and not force_evaluation:
        ...
        eval_data = extract_results(trackers, dataset, report_name,result_plot_path, **kwargs)
...
def plot_results(trackers, dataset, report_name,result_plot_path,merge_results=False,
    ...
    # Load pre-computed results
    result_plot_path = os.path.join(result_plot_path, report_name)
    eval_data = check_and_load_precomputed_results(trackers, dataset, report_name, result_plot_path, force_evaluation, **kwargs)
...
def print_results(trackers, dataset, report_name, result_plot_path, merge_results=False,
    ...
    """
    # Load pre-computed results
    eval_data = check_and_load_precomputed_results(trackers, dataset, report_name, result_plot_path, **kwargs)
...
def plot_got_success(trackers, report_name,result_plot_path,got_reports_path):
    ...
    for trk_id, trk in enumerate(trackers):
        json_path = '{}/{}.json'.format(got_reports_path, trk.name)
...
def print_per_sequence_results(trackers, dataset, report_name,result_plot_path, merge_results=False,
